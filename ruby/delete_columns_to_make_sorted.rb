...
# For example,
# if we have an array A = ["abcdef", "uvwxyz"] and deletion indices {
#     0,
#     2,
#     3
...
#     After choosing D = {
#         1
#     }, each column["c", "d", "g"] and["a", "f", "i"] are 
#     in non - decreasing sorted order.
# If we chose D = {}, then a column["b", "a", "h"] would 
# not be in non - decreasing sorted order.
# Example 2:
